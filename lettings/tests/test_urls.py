...
class TestUrls(TestCase):
    ...
    def setUp(self):
        """La méthode initialise une adresse, un client et une location pour les tests"""
        self.client = Client()
    ...
    def test_index_letting_url(self):
        """La méthode permet de tester le statut de la page et verifie le nom de de l'url"""
    ...
    def test_letting_url(self):
        """La méthode permet de tester le statut de la page, l'id de la location et verifie le nom de l'url"""
